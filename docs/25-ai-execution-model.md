...
```text
产品定义和需求：docs/01-product-definition.md、docs/02-mvp-scope.md
总体架构：docs/03-architecture-overview.md
领域和数据模型：docs/05-domain-model.md、docs/06-data-model.md
同步与离线：docs/07-sync-and-offline.md
AI/MCP：docs/08-mcp-design.md、docs/09-ai-interaction-design.md
客户端：docs/10-client-app.md、docs/22-ui-information-architecture.md
服务端 API：docs/11-backend-api.md
业务模块：docs/12-asset-system.md 到 docs/18-audit-trash.md
DevOps 与版本规则：docs/20-devops-deployment.md
测试与质量：docs/21-testing-quality.md
路线图：docs/24-roadmap.md
```
