...
abstract class LocalCoreBridge {
  ...
  Future<LocalLedgerTransactionRecord> createExpense(Map<String, Object?> input, LocalCoreContext context);
  Future<List<LocalLedgerTransactionRecord>> searchExpenses(Map<String, Object?> input, LocalCoreContext context);
  ...
  Future<LocalAssetRecord> registerExternalAsset(Map<String, Object?> input, LocalCoreContext context);

  Future<LocalCaptureSession> captureParse(Map<String, Object?> input, LocalCoreContext context);
  Future<LocalCaptureCommitResult> captureCommit(Map<String, Object?> input, LocalCoreContext context);
